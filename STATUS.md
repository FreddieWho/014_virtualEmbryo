# Virtual Embryo 项目状态
最新事件（2026-09-21）：R6已完成整基因留出及最终训练/目标推断；图模型留出MSE优于两个对照，但r6ridge/r6graph负值33.61%/38.72%均超过1%，FAILED_DISASTER，0候选，未提交/未评分。R5 v0032/v0033仍待回分；best不变。 见 reports/t3_r6_execution_20260921/REPORT.md。以下为历史阶段摘要。
