#!/usr/bin/env python3
"""G1-T1-R4 gene-shrinkage deltas: regularize noisy-gene shifts toward zero.

R1/R2/R3 lesson: assignment is not the lever (null/negative/more-negative). The remaining
degree of freedom is the DELTA VALUES: v0004 applies full per-type mean delta to every gene
...
def main() -> int:
    ...
    ap.add_argument("--out-version", default="v0018_g0_t1_r4_shrink")
    ...
    a.uns["ve_g0_t1_r4"] = json.dumps({"atom_id": TASK_ID, "lane": lane,
        "method": f"tstat_shrinkage_C{shrink_c:g}", "parent": "v0004 recipe",
